...
# Result ~11.18034
print(f"|           Метод               |  Результат  |")
print(f"|За методом правих прямокутників|{integral_right_rectangle:.10f}|")
print(f"|За методом лівих прямокутників |{integral_left_rectangle:.10f}|")
print(f"|За методом трапецій            |{integral_trapezoidal:.10f}|")
print(f"|Очікуваний результат           |{true_result:.10f}|")
